...
class OkulusDrawable extends Drawable {
    ...
    public OkulusDrawable(Bitmap bitmap, float cornerRadius,
              boolean fullCircle, float borderWidth,
              int borderColor, float shadowSize, int shadowColor,
              int touchSelectorColor, ImageView.ScaleType scaleType) {
